function model = normalizedWeightedTargetModel(image, windowProfileFcnHandle, histogramBins)
    ...
    [model.histogram, model.binIdxMap] = mexNormalizedWeightedHistogram(double(image), kernel, histogramBins, range(1), range(2));
